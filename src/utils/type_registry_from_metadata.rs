...
#[cfg(feature = "legacy")]
pub fn type_registry_from_metadata(
    ...
    match metadata {
        ...
        frame_metadata::RuntimeMetadata::V12(m) => {
            impl_for_v8_to_v13!(new_types, m, use_builtin_index)
        }
        frame_metadata::RuntimeMetadata::V13(m) => {
            impl_for_v8_to_v13!(new_types, m, use_builtin_index)
        }
