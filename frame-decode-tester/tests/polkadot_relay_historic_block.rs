...
use common::{
    POLKADOT_RELAY_RPC_URLS, POLKADOT_RELAY_SPEC_MARKERS, TestTier, connections_for_extrinsics,
...
#[tokio::test]
async fn test_polkadot_relay_historic_blocks() {
    ...
    eprintln!(
        "METRIC decode_extrinsics chain=polkadot_relay tier={tier:?} connections={connections} markers={} blocks_per_marker={bpm} blocks={} extrinsics={} failures={} secs={:.3}",
        markers.len(),
        tester.block_count(),
