...
use common::{
    KUSAMA_RELAY_RPC_URLS, KUSAMA_RELAY_SPEC_MARKERS, TestTier, connections_for_storage,
...
async fn test_kusama_relay_historic_storage() {
    ...
    eprintln!(
        "METRIC decode_storage chain=kusama_relay tier={tier:?} connections={connections} markers={} blocks_per_marker={bpm} blocks={} values={} failures={} secs={:.3}",
        markers.len(),
        tester.block_count(),
        tester.value_count(),
